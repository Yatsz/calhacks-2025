        ...
        {campaigns.length === 0 ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-7xl mx-auto">
            {campaigns.map((campaign) => (
              <div
                key={campaign.id}
                className="backdrop-blur-xl bg-white/60 rounded-2xl border border-white/60 shadow-xl overflow-hidden hover:shadow-2xl transition-shadow"
              >
                {/* Media Preview */}
                ...
                <div className="p-4">
                  ...
                  <div className="flex items-center justify-between gap-2">
                    ...
                    <div className="flex gap-2">
                      <Link href={`/adintelligence?edit=${campaign.id}`}>
                        <Button
                          variant="ghost"
                          size="sm"
